...
bool WifiManager::initAPMode(String ssid,String gateway,String pass, String newHostname)
{
        ...
        server.on("/config", HTTP_POST, [ssid,gateway,pass](AsyncWebServerRequest *request){
          //process config page 
          processConfig(request);
